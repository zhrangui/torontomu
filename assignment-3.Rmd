...
# Pearson correlation should be used to discuss the relation between youtube and sales, because the data from youtube and sales are continuous numeric data.
