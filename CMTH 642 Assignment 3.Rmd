...
#medium
ConfusionMatrix[3,1]/sum(ConfusionMatrix[3,])
#Specificity = TN / (FP + TN)
#high
sum(ConfusionMatrix[2:3,2:3])/sum(ConfusionMatrix[2:3,])
#low
sum(ConfusionMatrix[c(1,3),c(1,3)])/sum(ConfusionMatrix[c(1,3),])
#medium
sum(ConfusionMatrix[1:2,1:2])/sum(ConfusionMatrix[1:2,])
```
