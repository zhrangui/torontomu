...
```{r}
sum(titanicDataset[titanicDataset$sex=="male",]$survived, na.rm=T)/nrow(titanicDataset[titanicDataset$sex=="male",])
sum(titanicDataset[titanicDataset$sex=="female",]$survived, na.rm=T)/nrow(titanicDataset[titanicDataset$sex=="female",])
