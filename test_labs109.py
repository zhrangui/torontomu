...
def test_words_with_given_shape():
    assert words_with_given_shape(
        ['congeed'], [1, -1, -1, -1, 0, -1]) == ['congeed']
...
def test_verify_betweenness():
    assert verify_betweenness(p[5, 2, 0, 3, 1, 4], [(
        4, 3, 5), (2, 0, 4), (2, 1, 4), (1, 2, 5), (4, 0, 5)])
...
def test_spread_the_coins():
    assert spread_the_coins([111, 12, 12], 19, 6) == (-6, [19, 13, 13, 13, 13, 13, 10, 23, 18])
